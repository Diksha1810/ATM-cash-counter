...
export function Navbar({ isOnline, pendingCount, onSync, isSyncing }) {
  ...
  return (
    ...
    >
      {/* Left: logo + nav menu */}
      <Space size="middle">
        <Space style={{ cursor: 'pointer' }} onClick={() => navigate('/dashboard')}>
        ...
        <Menu
          ...
          style={{ borderBottom: 'none', background: 'transparent', minWidth: 280 }}
        />
      </Space>
      ...
      <Space size="middle">
        ...
        <Tag
          ...
          style={{ padding: '4px 10px', fontSize: '13px', borderRadius: '12px', margin: 0 }}
        >
